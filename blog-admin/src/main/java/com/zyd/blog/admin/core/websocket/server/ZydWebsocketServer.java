package com.zyd.blog.admin.core.websocket.server;

import com.zyd.blog.admin.core.websocket.util.WebSocketUtil;
...
public class ZydWebsocketServer {
     ...
     * 线程安全的socket集合
     */
    private static final Set<Session> webSocketSet = new CopyOnWriteArraySet<>();
    /**
     * 初始在线人数
     */
