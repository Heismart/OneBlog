package com.zyd.blog.admin.core.websocket.util;
...
public class WebSocketUtil {
    ...
    public static void sendNotificationMsg(String msg, Set<Session> sessionSet) throws UnsupportedEncodingException {
        ...
        broadcast(generateMsg(NOTIFICATION_MSG_KEY, URLEncoder.encode(msg, StandardCharsets.UTF_8.displayName())), sessionSet);
    }
...
//            }
//        }
        sessionSet.removeIf(entry-> null == entry || !entry.isOpen());
        sessionSet.forEach(session -> sendMessage(message,session));
    }
}
