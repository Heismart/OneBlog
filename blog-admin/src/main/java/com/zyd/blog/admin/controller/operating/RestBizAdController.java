package com.zyd.blog.admin.controller.operating;
...
public class RestBizAdController extends BaseRestController {
    @Autowired
    ...
    public ResponseVO edit(BizAdBo bizAd) {
        try {
            ...
            printErrLog("广告修改失败！",e);
            return ResultUtil.error("广告修改失败！");
        }
